...
STANDARDS_BLOCK = (
    ...
    "  - Edit-Strategie smart waehlen: pauschale Renames/Pattern-Replace per sed,\n"
    "    nicht via N MultiEdit-Calls. Boilerplate-Generierung per Template + sed-\n"
    "    Substitution > Hand-Edit pro File. Strukturelle Aenderungen am AST > Regex-Hacks.\n"
    "    Faustregel: wenn dieselbe Aenderung an >3 Stellen passiert, ist sed/script-Loesung\n"
    ...
    "    auslegen, dass Agents autonom testen koennen (deterministisch, isolierbar,\n"
    "    keine fragilen externen Abhaengigkeiten in Unit-Tests).\n"
...
# explicitly by GATE 2. Pläne, die diese Kriterien nicht erfuellen, blockieren
# bei GATE 2.
PLAN_QUALITY_BLOCK = (
    "PLAN-QUALITAET (PFLICHT, GATE 2 prueft)\n"
    "  Ein guter Plan ist edit-optimiert: er ermoeglicht zuegige, korrekte,\n"
    ...
    "     mit 4 Aenderungen' vs 'Write neuer File <pfad>'. Vermeide implizite\n"
    ...
    "     Wenn ja, Markierung 'PARALLEL: B2' o.ae. setzen. Subagents fuer\n"
    ...
    "  Plaene muessen ausfuehrlich genug sein, dass der Engineer ohne weitere\n"
...
TEST_STRATEGY_BLOCK = (
    ...
    "    transitiven Abhaengigkeiten. Zielwert: <30s Test-Run pro Cycle.\n"
    ...
    "    fuer die Aenderung relevanten Tests laufen.\n"
...
MID_RUN_PERSISTENCE_BLOCK = (
    ...
    "  Erkenntnisse die im Loop entstehen MUESSEN persistiert werden, nicht\n"
...
CONTEXT_ECONOMY_BLOCK = (
    "KONTEXT-OEKONOMIE (PFLICHT FUER ALLE AGENTS)\n"
...
def _briefing_gate_prompts(*, wt_path: Path, base: str) -> str:
    ...
    return (
        ...
        "       parallel laufen koennten (z.B. zwei Module ohne Abhaengigkeit)?\n"
        "       Wenn Plan diese seriell vorsieht ohne Begruendung -> WARNING.\n"
        "   12. Edit-Effizienz: bei N>3 sehr aehnlichen Aenderungen ist sed/script-\n"
...
def _briefing_orchestrator(
    *, writer_pane: str, writer_agent: str,
    ...
    return (
        ...
        f"{PRE_FLIGHT_BLOCK}\n"
        f"DUTIES IN ORDER\n\n"
        f"1. RECON (Subagent wenn tief, siehe KONTEXT-OEKONOMIE)\n"
        ...
        f"   exakt so fuer GATE 2 + GATE 3 + Engineer-Briefings.\n\n"
        ...
        f"     - Commit-Strategie: im Loop wie der Engineer mag, ausfuehrliche\n"
