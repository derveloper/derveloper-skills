...
CONTEXT_ECONOMY_BLOCK = (
    ...
    "    <300 words'. Mehrere unabhängige Researches PARALLEL (eine Nachricht,\n"
    "    mehrere Task-Calls).\n"
    ...
    "    Du selbst bleibst aktiv; Human compactet dich falls nötig.\n"
    "\n"
    "  Writer-spezifisch:\n"
...
FRONTEND_SMOKE_BLOCK = (
    "FRONTEND-SMOKE (PFLICHT BEI UI-BULLETS)\n"
    ...
    "  1. frontend-design-Skill aktiv nutzen wenn Bullet 'gut aussehen' soll oder\n"
    "     ein Vorbild-Repo benannt ist (z.B. github.com/foo/bar). Skill liefert\n"
    "     Layout-Pattern, Spacing, Typography-Tokens. Nicht freihand stylen.\n"
    ...
    "       benannt. Layout-Drift gegen Vorbild = Fix vor REVIEW-READY.\n"
    "  3. Smoke-Output (Schritte + Screenshot-Pfade + 'pass'/Findings) in\n"
    "     REVIEW-READY-Ping zitieren. Nicht nur 'getestet'.\n"
    "\n"
    "  Pflichten Reviewer:\n"
    "  - Wenn Bullet UI ist und Writer keinen Smoke-Output zitiert: REVIEW BLOCK,\n"
    "    Engineer muss Smoke nachreichen. Kein 'Code sieht gut aus, approve'.\n"
    ...
    "\n"
    "  Begründung: API-Tests + Unit-Tests fangen UI-Bugs nicht. Reine Backend-\n"
    "  Verifier sieht 200 OK auf /projects, aber nicht dass die Seite ungestylt\n"
    "  ist oder Sessions nicht persistiert werden. Browser-Smoke ist die einzige\n"
    "  Cross-Check-Schicht zwischen Engineer und User-Smoke. Ohne sie ist GATE 3\n"
    "  PASS systematisch unter Wert.\n"
)
...
def _briefing_gate_prompts(*, wt_path: Path, base: str) -> str:
    ...
    return (
        ...
        "    9. PLAN-QUALITÄT: Pro Bullet konkrete Files+Funktionen+Zeilen?\n"
        ...
        "   10. TESTS: hat der Plan Tests in den Bullets verankert (außer bei\n"
        "       explizit als 'Frickel' markierten Projekten)? Wenn Tests fehlen\n"
        "       und kein Frickel-Marker da ist -> BLOCKER.\n"
        "   11. PARALLELISIERUNG: gibt es Bullets die unabhängig sind und\n"
        "       parallel laufen könnten (z.B. zwei Module ohne Abhängigkeit)?\n"
        "       Wenn Plan diese seriell vorsieht ohne Begründung -> WARNING.\n"
        ...
        "   13. FRONTEND-SMOKE: Bei UI-Bullets (HTML/CSS/JS/Templates/HTML-Routen)\n"
        "       MUSS der Plan playwright-skill-Browser-Smoke + frontend-design-Skill\n"
        "       als pflicht vor REVIEW-READY pro Bullet vorsehen. Bei benanntem\n"
        "       Vorbild-Repo zusätzlich Visual-Diff-Schritt. Wenn Plan UI hat aber\n"
        "       Smoke nicht verankert -> BLOCKER.\n"
        "    \n"
        ...
        "    8. FRONTEND-SMOKE-Verifikation bei UI-Bullets: hat der Writer Smoke-\n"
        "       Output (Schritte + Screenshot-Pfade + pass/Findings) im DONE-Ping\n"
        "       zitiert? Wenn UI-Bullet ohne zitierten Smoke -> BLOCKER. Reines\n"
        "       Backend-Verify deckt UI-Bugs nicht ab.\n"
        "    \n"
        "    Output:\n"
        "    VERDICT: PASS | BLOCKER | WARNING\n"
        "    BLOCKERS:\n"
        ...
        "    6. FRONTEND-SMOKE: bei UI-Diffs (HTML/CSS/JS/Templates/HTML-Routen)\n"
        "       muss Writer playwright-Smoke-Output im DONE-Ping zitieren\n"
        "       (Schritte + Screenshot + pass/Findings). Fehlt der Output ODER\n"
        "       deckt er nicht die Bullet-Done-Definition (z.B. nur Render-OK\n"
        "       statt Nutzeraktion) -> BLOCKER. Visual-Diff gegen benanntes\n"
        "       Vorbild-Repo wenn klar abweichend -> WARNING oder BLOCKER je\n"
        "       nach Schwere.\n"
        "    \n"
        "    Output:\n"
        "    VERDICT: PASS | BLOCKER | WARNING\n"
...
def _briefing_orchestrator(
    *, writer_pane: str, writer_agent: str,
    ...
    return (
        ...
        f"     Mehrere unabhängige Researches PARALLEL (eine Nachricht, mehrere Task-Calls).\n"
        ...
        f"3. PLAN ERSTELLEN (siehe PLAN-QUALITÄT-Block oben)\n"
        ...
        f"   Subagent prüft auch Plan-Qualität (Edit-Strategien, Tests, Parallelisierung).\n"
        ...
        f"     - Plan-Bullets aus Schritt 3 voll ausgeschrieben (nicht abkürzen),\n"
