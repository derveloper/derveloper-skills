...
def _briefing_gate_prompts(*, wt_path: Path, base: str) -> str:
    ...
    return (
        ...
        "   13. FRONTEND-SMOKE + DESIGN-SKILL: Bei UI-Bullets (HTML/CSS/JS/\n"
        "       Templates/HTML-Routen) MUSS der Plan ALLE 6 Done-Positionen pro\n"
        "       Bullet verankern: (a) playwright-Smoke, (b) frontend-design-Skill\n"
        "       Pflicht (auch ohne Vorbild), (c) Visual-Diff bei benanntem\n"
        "       Vorbild-Repo, (d) frontend-quality.md Limits, (e) Accessibility-\n"
        "       Floor, (f) design-tokens.md respektieren. Wenn Plan UI hat aber\n"
        "       eine Position fehlt -> BLOCKER. Keine 'optional' UI-Bullets.\n"
        "    \n"
        ...
        "    8. FRONTEND-SMOKE + DESIGN-SKILL bei UI-Bullets: hat der Writer\n"
        "       ALLE 6 Done-Positionen zitiert? (a) Smoke-Output mit Schritten\n"
        "       + Screenshots + pass/Findings, (b) frontend-design-Skill-Output\n"
        "       (Layout-Pattern + Spacing + Typography), (c) Visual-Diff gegen\n"
        "       Vorbild wenn benannt, (d) frontend-quality.md Limits, (e)\n"
        "       Accessibility-Floor (Keyboard, Focus, ARIA, Contrast, reduced-\n"
        "       motion), (f) design-tokens.md respektiert. Wenn UI-Bullet ohne\n"
        "       eine Position -> BLOCKER. Reines Backend-Verify deckt UI-Bugs\n"
        "       nicht ab.\n"
        "    \n"
        "    Output:\n"
        "    VERDICT: PASS | BLOCKER | WARNING\n"
        ...
        "       Screenshot + pass/Findings), (b) frontend-design-Skill-Output\n"
        "       (Layout + Spacing + Typography-Tokens), (c) Visual-Diff gegen\n"
        "       Vorbild wenn benannt, (d) frontend-quality.md Limits, (e)\n"
        "       Accessibility-Floor, (f) design-tokens.md respektiert. Fehlt\n"
        "       eine Position ODER deckt der Smoke nicht die Bullet-Done-\n"
        "       Definition ab -> BLOCKER. Visual-Diff gegen Vorbild klar\n"
        "       abweichend -> BLOCKER (nicht WARNING, ungefertige UIs sind\n"
        "       nicht akzeptabel).\n"
        "    \n"
        "    Output:\n"
        "    VERDICT: PASS | BLOCKER | WARNING\n"
